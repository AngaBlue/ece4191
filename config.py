...
# General
WINDOW_SCALE = 1.6    # scale camera view in window (1.0 = 640x480)
...
# Joysticks
DEADZONE = 0.5             # joystick deadzone (0.0–0.2 typical)
...
# YOLO
YOLO_MODEL = os.environ.get("YOLO_MODEL", "model-kctfpck.pt")
